...
import com.wilyra.halocompanion.haloapi.model.common.TopGameBaseVariant;
...
public class ArenaStats_ {

    @SerializedName("ArenaPlaylistStats")
    @Expose
    private ArenaPlaylistStat ArenaPlaylistStats[];
    @SerializedName("HighestCsrAttained")
    @Expose
    private com.wilyra.halocompanion.haloapi.model.arenastats.HighestCsrAttained HighestCsrAttained;
    @SerializedName("ArenaGameBaseVariantStats")
    @Expose
    private ArenaGameBaseVariantStat[] ArenaGameBaseVariantStats;
    @SerializedName("TopGameBaseVariants")
    @Expose
    private TopGameBaseVariant[] TopGameBaseVariants;
     ...
     * 
     * @return
     *     The ArenaPlaylistStats
     */
    public ArenaPlaylistStat[] getArenaPlaylistStats() {
        return ArenaPlaylistStats;
    }

    /**
     *
     * @param ArenaPlaylistStats
     *     The ArenaPlaylistStats
     */
    public void setArenaPlaylistStats(ArenaPlaylistStat[] ArenaPlaylistStats) {
     ...
     * 
     * @return
     *     The HighestCsrAttained
     */
    public com.wilyra.halocompanion.haloapi.model.arenastats.HighestCsrAttained getHighestCsrAttained() {
        return HighestCsrAttained;
    }

    /**
     * 
     * @param HighestCsrAttained
     *     The HighestCsrAttained
     */
    public void setHighestCsrAttained(com.wilyra.halocompanion.haloapi.model.arenastats.HighestCsrAttained HighestCsrAttained) {
     ...
     * 
     * @return
     *     The ArenaGameBaseVariantStats
     */
    public ArenaGameBaseVariantStat[] getArenaGameBaseVariantStats() {
        return ArenaGameBaseVariantStats;
    }

    /**
     *
     * @param ArenaGameBaseVariantStats
     *     The ArenaGameBaseVariantStats
     */
    public void setArenaGameBaseVariantStats(ArenaGameBaseVariantStat[] ArenaGameBaseVariantStats) {
     ...
     * 
     * @return
     *     The TopGameBaseVariants
     */
    public TopGameBaseVariant[] getTopGameBaseVariants() {
        return TopGameBaseVariants;
    }

    /**
     *
     * @param TopGameBaseVariants
     *     The TopGameBaseVariants
     */
    public void setTopGameBaseVariants(TopGameBaseVariant[] TopGameBaseVariants) {
